...
var TokenTrackingService_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.TokenTrackingService = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../prisma/prisma.service");
let TokenTrackingService = TokenTrackingService_1 = class TokenTrackingService {
    prisma;
    logger = new common_1.Logger(TokenTrackingService_1.name);
    pricing = {
        openai: {
    ...
    async trackTokenUsage(data) {
        try {
            ...
            this.logger.log(`Token usage tracked: ${data.provider}/${data.model} - ${data.totalTokens} tokens ($${data.estimatedCost.toFixed(4)})`);
        }
        catch (error) {
    ...
    async getTokenUsageStats(options) {
        ...
        const [totalUsage, usageByProvider, usageByModel, dailyUsage, userUsage] = await Promise.all([
    ...
    async getDailyUsageStats(where) {
...
exports.TokenTrackingService = TokenTrackingService = TokenTrackingService_1 = __decorate([
