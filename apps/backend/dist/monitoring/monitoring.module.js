...
exports.MonitoringModule = MonitoringModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [monitoring_service_1.MonitoringService, logger_service_1.CustomLoggerService, prisma_service_1.PrismaService],
        exports: [monitoring_service_1.MonitoringService, logger_service_1.CustomLoggerService],
    })
], MonitoringModule);
